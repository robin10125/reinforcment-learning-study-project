...
class LinearSchedule(object):
    ...
    def update(self, t):
        ...
        self.epsilon = max( self.eps_end, self.eps_begin + ((self.eps_end-self.eps_begin) * t/self.nsteps) )
...
class LinearExploration(LinearSchedule):
    ...
    def get_action(self, best_action):
        ...
        ##############################################################
        #0or1 = int(self.episilon >= rand)
        #arr = [best_action, self.env.action_space.sample()]
        #return arr[0or1]
        ######################## END YOUR CODE #######################
